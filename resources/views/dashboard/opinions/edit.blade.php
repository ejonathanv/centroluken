            ...
            <div class="w-6/12 mx-auto">
                ...
                <form action="{{ route('opinions.update', $opinion) }}" method="POST" class="mt-7" enctype="multipart/form-data" id="opinion-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="author" value="{{ old('author', $opinion->author) }}">
                        @error('author')
                            <span class="text-xs text-red-500">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date_published" value="{{ old('date_published', $opinion->date_published?->format('Y-m-d')) }}">
                    ...
                    <div class="form-group">
                        ...
                        <label class="flex items-center space-x-2 cursor-pointer">
                            <input type="checkbox" name="on_homepage" value="1" id="on_homepage" {{ old('on_homepage', $opinion->on_homepage) ? 'checked' : '' }}>
                    ...
                    @php
                        $showPosition = old('on_homepage', $opinion->on_homepage);
                        $currentPosition = old('position', $opinion->position);
                    @endphp
                    <div class="form-group" id="position-group" style="{{ $showPosition ? '' : 'display: none;' }}">
                        ...
                        <select class="form-control" name="position" id="position">
                            ...
                            <option value="3" {{ $currentPosition == 3 ? 'selected' : '' }}>3</option>
                        </select>
                        @error('position')
                            <span class="text-xs text-red-500">{{ $message }}</span>
                        @enderror
