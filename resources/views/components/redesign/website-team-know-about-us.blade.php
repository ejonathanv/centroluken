@php
    $image = asset('redesign/img/team/1000_F_627164543_C848BH8LKBnWxhTwRvEAwUePrc3S5WX5.webp');
@endphp
<section class="flex flex-col flex-col-reverse md:flex-row items-stretch min-h-[300px] lg:min-h-[500px]">
    ...
    <div class="min-h-[250px] md:min-h-0 w-full md:w-1/2 bg-cover bg-center relative overflow-hidden" style="background-image: url('{{ $image }}')">
        <div class="hidden md:block absolute top-0 left-0 bottom-0 w-[150px] bg-secondary bg-opacity-30 wow animate__animated animate__fadeInLeft"></div>
        <div class="block md:hidden absolute left-0 bottom-0 right-0 h-[90px] bg-secondary bg-opacity-30 wow animate__animated animate__fadeInUp"></div>
    </div>
</section>