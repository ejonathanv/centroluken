<div class="flex flex-col md:flex-row items-stretch min-h-[300px] lg:min-h-[500px]">
    <div class="min-h-[250px] md:min-h-0 w-full md:w-1/2 bg-cover bg-center relative overflow-hidden" style="background-image: url('{{ $image }}')">
        <div class="hidden md:block absolute top-0 right-0 bottom-0 w-[75px] lg:w-[150px] bg-primary bg-opacity-50 wow animate__animated animate__fadeInRight" data-wow-delay="0.4s"></div>
        <div class="block md:hidden absolute right-0 bottom-0 h-[90px] w-full bg-primary bg-opacity-50 wow animate__animated animate__fadeInUp" data-wow-delay="0.4s"></div>
    </div>
