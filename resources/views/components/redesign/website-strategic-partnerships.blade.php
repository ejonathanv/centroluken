<section class="pb-10 lg:pb-20 bg-white mt-28">
    <div class="container">
        ...
        <div class="flex flex-col md:flex-row space-y-5 md:space-y-0 items-center justify-center space-x-0 md:space-x-5 relative left-0 md:-left-5" style="z-index: 100;">
            <div class="w-9/12 md:w-1/5 flex items-center justify-center wow animate__animated animate__fadeInUp">
                <a href="https://www.reviveelrio.org/" target="_blank" rel="noopener noreferrer">
            ...
            <div class="w-9/12 md:w-1/5 flex items-center justify-center wow animate__animated animate__fadeInUp" data-wow-delay="0.2s">
                <a href="https://www.waltonfamilyfoundation.org/" target="_blank" rel="noopener noreferrer">
            ...
            <div class="w-9/12 md:w-1/5 flex items-center justify-center wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                <a href="https://www.b-e-f.org/" target="_blank" rel="noopener noreferrer">
            ...
            <div class="w-9/12 md:w-1/5 flex items-center justify-center wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                <a href="https://bluecommons.org/rebeaver/" target="_blank" rel="noopener noreferrer">
            ...
            <div class="w-9/12 md:w-1/5 flex items-center justify-center wow animate__animated animate__fadeInUp" data-wow-delay="0.8s">
                <a href="https://fundaciongonzalorioarronte.org/" target="_blank" rel="noopener noreferrer">
