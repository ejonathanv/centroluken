    ...
    <div class="container">
        ...
        <div class="flex items-stretch justify-center flex-col md:flex-row flex-wrap">
            ...
            <div class="w-full md:w-1/3 p-4 lg:p-8 text-center wow animate__animated animate__fadeInUp" data-wow-delay="0.4s">
                ...
                <p class="font-bold text-xs">Socio fundador</p>
            </div><div class="w-full md:w-1/3 p-4 lg:p-8 text-center wow animate__animated animate__fadeInUp" data-wow-delay="0.6s">
                ...
                <p class="font-bold text-xs">Socio fundador</p>
            </div><div class="w-full md:w-1/3 p-4 lg:p-8 text-center wow animate__animated animate__fadeInUp" data-wow-delay="0.8s">
