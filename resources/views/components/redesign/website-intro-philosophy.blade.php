<section class="py-10 md:py-16">
    <div class="container">
        <div class="w-10/12 md:w-8/12 mx-auto text-center mb-24">
    ...
    <div class="flex items-stretch space-x-10 justify-between px-16">
        <div class="w-3/12 wow animate__animated animate__fadeInLeft">
        ...
        <div class="w-6/12 relative wow animate__animated animate__fadeInUp">
            <img src="{{ asset('redesign/svg/half-curve.svg') }}"
                alt="Misión"
                class="w-full h-auto relative -top-[30px]">
        </div>
        <div class="w-3/12 wow animate__animated animate__fadeInRight">
            <h3 class="text-xl font-bold mb-4 text-primary">
                Visión
            </h3>
            <p class="text-sm lg:text-sm">
