<x-redesign.website-layout :title="__('2026/philosophy.meta_title')">
    <x-redesign.website-founder-bio 
        :name="__('2026/about.team.partners.four.name')"
        pictureOne="{{ asset('redesign/img/philosophy/founder-4.jpg') }}"
        pictureTwo="https://placehold.co/600x400">
        @foreach (trans('2026/about.team.partners.four.bio') as $paragraph)
